 ...
 * Dicha clase se encarga de la hebra que controla un vehiculo simulado
...
public class VehicleThread implements Runnable{
     ...
     */
    public VehicleThread(Node f, Node d, String l, Controller c){
        from=f;
        to=d;
        label=l;
        controller=c;
    ...
    /**
     * Metodo que se encarga del movimiento de los vehiculos simulados. 
        ...
        try{
            ...
            while(continuar){ 
                ...
                for(int i=0; i<offset; i++){
                    ...
                    Thread.sleep(delay);
                    setXY();                    
                    controller.getFrame().getPanelMap().repaint(); 
                ...
                if(from.equals(to)){
                    terminar();
                    //Una vez que ha terminado la eliminamos de la lista
                    controller.getFrame().getModel().getGraph().getVehicleList().remove(this);
    ...
    private void getNext() throws ClassNotFoundException_Exception, FileNotFoundException_Exception, IOException_Exception {
        ...
        List<String> ruta = obtenerRutaTiempo(origen,destino); 
        while (ruta.size()==0){
